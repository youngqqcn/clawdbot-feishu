...
```bash
openclaw plugins install @youngqqcn/openclaw-feishu
```

Or install via npm:

```bash
npm install @youngqqcn/openclaw-feishu
```
...
curl -O https://registry.npmjs.org/@youngqqcn/openclaw-feishu/-/feishu-0.1.1.tgz
